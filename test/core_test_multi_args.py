...
LIVING_THING = onto.add_entity("LIVING_THING", word_type="NOUN", entity_types=[CATEGORY], description="A living organism")
BODY_PART = onto.add_entity("BODY_PART", word_type="NOUN", entity_types=[CATEGORY], description="A part of a body")
HUMAN = onto.add_entity("HUMAN", word_type="NOUN", entity_types=[LIVING_THING], description="A human being")
HEAD = onto.add_entity("HEAD", word_type="NOUN", entity_types=[BODY_PART], description="Human head")
